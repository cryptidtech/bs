...
pub trait AsyncSigner: Signer {
    ...
    fn try_sign_async<'a>(
        ...
        key: &'a Self::Key,
        data: &'a [u8],
    ) -> impl Future<Output = Result<Self::Signature, Self::Error>> + 'a;
...
pub trait AsyncEncryptor: Encryptor {
    ...
    ) -> impl Future<Output = Result<Self::Ciphertext, Self::Error>> + 'a;
...
pub trait AsyncDecryptor: Decryptor {
    ...
    ) -> impl Future<Output = Result<Self::Plaintext, Self::Error>> + 'a;
}
...
pub trait AsyncSecretCombiner: SecretCombiner {
    ...
    ) -> impl Future<Output = Result<Self::Secret, Self::Error>> + 'a;
}
...
pub trait AsyncGetKey: GetKey {
    ...
    fn get_key_async<'a>(
        ...
        threshold: usize,
        limit: usize,
    ) -> impl Future<Output = Result<Self::Key, Self::Error>> + 'a;
}
